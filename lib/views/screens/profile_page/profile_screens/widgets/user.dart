...
import 'package:accum_points_app/views/screens/profile_page/profile_screens/account.dart';
import 'package:accum_points_app/views/screens/profile_page/profile_screens/individual.dart';
    ...
    return Container(
      ...
      child: Row(
       children: [
        GestureDetector(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context) => const Individual()));
          },
          child: Row(
            children : [
              Container(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(image: AssetImage("assets/images/Chevron_Right.png"), fit: BoxFit.cover)
                  ),
                ),
              ),
              GestureDetector(
