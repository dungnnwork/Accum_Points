        ...
        children: [
          const BackgroundPage(),
             ...
             const  BackgroundOffer(),
              ...
              const   DottedLine(lineThickness: 0.1,),
                      SizedBox(height: 15.h,),
                      ProfileAction(imageUrl: "assets/icons/icons_profile/book.png",des: "Lịch sử điểm",onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const PointHistory()));
                      },), 
              const   DottedLine(lineThickness: 0.1,),
                      SizedBox(height: 15.h,),
                      ProfileAction(imageUrl: "assets/icons/icons_profile/Group 172.png",des: "Yêu thích",onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const LoveScrenn()));
                      },),   
              const   DottedLine(lineThickness: 0.1,),
                      SizedBox(height: 15.h,),
              const   ProfileAction(imageUrl: "assets/icons/icons_profile/info-circle.png",des: "Về chúng tôi",),  
              const   DottedLine(lineThickness: 0.1,),
                      SizedBox(height: 15.h,),
              const   ProfileAction(imageUrl: "assets/icons/icons_profile/headphone.png",des: "Hỗ trợ",),
              const   DottedLine(lineThickness: 0.1,),
                      SizedBox(height: 15.h,),
              const   ProfileAction(imageUrl: "assets/icons/icons_profile/unlock.png",des: "Đổi mật khẩu",), 
              const   DottedLine(lineThickness: 0.1,),
                      SizedBox(height: 15.h,),
              const   ProfileAction(imageUrl: "assets/icons/icons_profile/login.png",des: "Đăng xuất",),                                         
                    ],
                  ),
                ),
        ],
