...
import 'package:accum_points_app/views/screens/qr_page/widget/my_qr_code.dart';
import 'package:accum_points_app/views/screens/qr_page/widget/qr_scan.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
            activeIcon: Icon(Icons.qr_code, color: Colors.blue,),
