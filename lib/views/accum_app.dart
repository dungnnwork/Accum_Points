...
class _AccumAppState extends State<AccumApp> {
  ...
  double width  = ScreenUtil().setWidth(375.0);
  double height = ScreenUtil().setHeight(812.0);
    ...
    return Container(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.only(
          topLeft: Radius.circular(ScreenUtil().radius(10.0)),
          topRight: Radius.circular(ScreenUtil().radius(10.0)),
