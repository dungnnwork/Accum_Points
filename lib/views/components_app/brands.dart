...
class Brand extends StatelessWidget {
  ...
  const Brand({Key? key, this.image,  this.nameBrand,  this.typeBrand}) : super(key: key);
    ...
    return Container(
          ...
          child: Column(
            children: [
              GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const DetailPartnerPage()));
                },
                child: Container(
              ...
              DottedLine(lineThickness: 0.1.w,),
            ],
          ),
        );
  }
